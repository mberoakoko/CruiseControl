...
def value_iteration(initial_state: ValueIteraState, params: ValueIterParams) -> typing.Iterator[ValueIteraState]:
    steping_function: typing.Callable[[ValueIteraState], ValueIteraState] = lambda state: _value_iter_step(state, params)
